...
var transformDecls = function transformDecls(styles, declarations, result) {
  for (var d in declarations) {
    ...
    if (shorthandBorderProps.indexOf(property) > -1) {
      ...
      var transformed = (0, _cssToReactNative2.default)([[property, value]]);
      ...
      Object.assign(styles, (0, _cssToReactNative2.default)([[property, value]]));
    }
  }
};

var transform = function transform(css, options) {
  var _parseCSS = (0, _parse2.default)(css),
  ...
  for (var r in stylesheet.rules) {
    ...
    if (rule.type == "media" && options != null && options.parseMediaQueries === true) {
      var parsed = _cssMediaquery2.default.parse(rule.media);
      ...
      parsed.forEach(function (mq) {
        ...
        mq.expressions.forEach(function (e) {
          var mf = e.modifier ? e.modifier + "-" + e.feature : e.feature;
          var val = e.value ? ": " + e.value : "";
          ...
          if (_features.dimensionFeatures.indexOf(e.feature) > -1 && lengthRe.test(e.value) === false) {
            throw new Error("Failed to parse media query expression \"(" + mf + val + ")\"");
          }
        });
      });
